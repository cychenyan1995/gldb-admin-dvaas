...
interface IUploadExcelFormProps {
  form: any
  step: any
  uploadProps: any
}

interface IUploadExcelFormStates {
  replaceModeState: number
}

export class UploadExcelForm extends React.PureComponent<IUploadExcelFormProps, IUploadExcelFormStates> {
  constructor (props) {
    super(props)
    this.state = {
      replaceModeState: 0
  ...
  public render () {
    ...
    const uploadComponent = (
      <Upload {...uploadProps} >
        <Button>
          <Icon type="upload" /> Click to Upload EXCEL
        </Button>
      </Upload>
    )
...
export default Form.create()(UploadExcelForm)
