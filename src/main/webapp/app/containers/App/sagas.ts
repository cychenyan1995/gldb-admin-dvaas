...
import { takeLatest, throttle, takeEvery } from 'redux-saga'
import { call, put } from 'redux-saga/effects'

const message = require('antd/lib/message')
import { LOGIN, GET_LOGIN_USER, CHECK_NAME,CHECK_NAME_ACTION, ACTIVE, UPDATE_PROFILE, CHANGE_USER_PASSWORD, JOIN_ORGANIZATION } from './constants'
import {
  logged,
  loginError,
  getLoginUserError,
...
export default function* rootGroupSaga (): IterableIterator<any> {
  yield [
    throttle(1000, CHECK_NAME_ACTION, checkName as any),
    takeLatest(CHECK_NAME, checkNameUnique as any),
